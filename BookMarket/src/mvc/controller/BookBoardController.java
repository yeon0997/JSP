...
import mvc.model.BookBoardDAO;
import mvc.model.BookBoardDTO;

public class BookBoardController extends HttpServlet {
	...
	public void requestBoardList(HttpServletRequest request){
		...
		BookBoardDAO dao = BookBoardDAO.getInstance();
		List<BookBoardDTO> boardlist = new ArrayList<BookBoardDTO>();
	...
	public void requestBoardWrite(HttpServletRequest request){
		...
		BookBoardDTO board = new BookBoardDTO();
